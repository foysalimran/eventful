...
if ( ! class_exists( 'EFP_Field_background' ) ) {
	class EFP_Field_background extends EFP_Fields {
		...
		public function render() {
			...
			echo '<div class="taf--background-colors">';
			...
			if ( ! empty( $args['background_color'] ) ) {
				...
				echo ( ! empty( $args['background_gradient'] ) ) ? '<div class="taf--title">' . esc_html__( 'From', 'ta-framework' ) . '</div>' : '';
			...
			if ( ! empty( $args['background_gradient_color'] ) && ! empty( $args['background_gradient'] ) ) {
				...
				echo ( ! empty( $args['background_gradient'] ) ) ? '<div class="taf--title">' . esc_html__( 'To', 'ta-framework' ) . '</div>' : '';
			...
			if ( ! empty( $args['background_gradient_direction'] ) && ! empty( $args['background_gradient'] ) ) {
				...
				echo ( ! empty( $args['background_gradient'] ) ) ? '<div class="taf---title">' . esc_html__( 'Direction', 'ta-framework' ) . '</div>' : '';
			...
			if ( ! empty( $args['background_image'] ) ) {
				...
				echo '<div class="taf--background-image">';

				EFP::field(
					array(
						'id'          => 'background-image',
						'type'        => 'media',
						'class'       => 'taf-assign-field-background',
			...
			$auto_class   = ( ! empty( $args['background_auto_attributes'] ) ) ? ' taf--auto-attributes' : '';
			$hidden_class = ( ! empty( $args['background_auto_attributes'] ) && empty( $this->value['background-image']['url'] ) ) ? ' taf--attributes-hidden' : '';

			echo '<div class="taf--background-attributes' . esc_attr( $auto_class . $hidden_class ) . '">';
