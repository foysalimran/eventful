  ...
  class EFP_Field_group extends EFP_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        ...
        'min'                       => 0,
        'fields'                    => array(),
        'button_title'              => esc_html__( 'Add New', 'eventful-pro' ),
      ...
      if ( preg_match( '/'. preg_quote( '['. $this->field['id'] .']' ) .'/', $this->unique ) ) {
        ...
        echo '<div class="efp-notice efp-notice-danger">'. esc_html__( 'Error: Field ID conflict.', 'eventful-pro' ) .'</div>';
        ...
        echo '<div class="efp-cloneable-item efp-cloneable-hidden" data-depend-id="'. esc_attr( $this->field['id'] ) .'">';
          ...
          echo '<i class="efp-cloneable-remove efp-confirm fas fa-times" data-confirm="'. esc_html__( 'Are you sure to delete this item?', 'eventful-pro' ) .'"></i>';
          echo '</div>';
        ...
        echo '<div class="efp-cloneable-alert efp-cloneable-max">'. esc_html__( 'You cannot add more.', 'eventful-pro' ) .'</div>';
        echo '<div class="efp-cloneable-alert efp-cloneable-min">'. esc_html__( 'You cannot remove more.', 'eventful-pro' ) .'</div>';
        echo '<a href="#" class="button button-primary efp-cloneable-add">'. $args['button_title'] .'</a>';
