  ...
  class EFP_Field_icon extends EFP_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        'button_title' => esc_html__( 'Add Icon', 'eventful-pro' ),
        'remove_title' => esc_html__( 'Remove Icon', 'eventful-pro' ),
      ) );
      ...
      echo '<a href="#" class="button button-primary efp-icon-add" data-nonce="'. esc_attr( $nonce ) .'">'. $args['button_title'] .'</a>';
      echo '<a href="#" class="button efp-warning-primary efp-icon-remove'. esc_attr( $hidden ) .'">'. $args['remove_title'] .'</a>';
      echo '<input type="hidden" name="'. esc_attr( $this->field_name() ) .'" value="'. esc_attr( $this->value ) .'" class="efp-icon-value"'. $this->field_attributes() .' />';
      echo '</div>';
          ...
          <div class="efp-modal-table-cell">
            ...
            <div class="efp-modal-inner">
              <div class="efp-modal-title">
                <?php esc_html_e( 'Add Icon', 'eventful-pro' ); ?>
                <div class="efp-modal-close efp-icon-close"></div>
              </div>
              <div class="efp-modal-header">
                <input type="text" placeholder="<?php esc_html_e( 'Search...', 'eventful-pro' ); ?>" class="efp-icon-search" />
              </div>
