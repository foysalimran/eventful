...
if ( ! class_exists( 'EFP_Field_upload' ) ) {
	class EFP_Field_upload extends EFP_Fields {
		...
		public function render() {
			...
			echo '<a href="#" class="button button-primary efp--button" data-library="' . esc_attr( $library ) . '">' . esc_html( $args['button_title'] ) . '</a>';
			echo '<a href="#" class="button button-secondary efp-warning-primary efp--remove' . esc_attr( $hidden ) . '">' . esc_html( $args['remove_title'] ) . '</a>';
			echo '</div>';
