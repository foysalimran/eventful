  ...
  class EFP_Options extends EFP_Abstract {
    ...
    public function add_admin_bar_menu( $wp_admin_bar ) {
      ...
      if ( ! empty( $this->args['show_bar_menu'] ) && empty( $this->args['menu_hidden'] ) ) {
        ...
        $menu_icon = ( ! empty( $this->args['admin_bar_menu_icon'] ) ) ? '<span class="eventful-ab-icon ab-icon '. esc_attr( $this->args['admin_bar_menu_icon'] ) .'"></span>' : '';
          ...
          foreach ( $sections['fields'] as $field ) {
            if ( ! empty( $field['id'] ) ) {
              if ( array_key_exists( $field['id'], $this->errors ) ) {
                $err = '<span class="eventful-label-error">!</span>';
              }
            }
          }
        }
    ...
    public function add_options_html() {
      ...
      $ajax_class    = ( $this->args['ajax_save'] ) ? ' eventful-save-ajax' : '';
      $sticky_class  = ( $this->args['sticky_header'] ) ? ' eventful-sticky-header' : '';
      ...
      echo '<div class="eventful eventful-options'. esc_attr( $theme . $class . $wrapper_class ) .'" data-slug="'. esc_attr( $this->args['menu_slug'] ) .'" data-unique="'. esc_attr( $this->unique ) .'">';
        ...
        echo '<div class="eventful-container">';
        ...
        echo '<div class="eventful-header-inner">';
          ...
          echo '<div class="eventful-header-right">';
            ...
            $notice_class = ( ! empty( $this->notice ) ) ? 'eventful-form-show' : '';
        ...
        echo '<div class="eventful-wrapper'. esc_attr( $show_all ) .'">';
          ...
          if ( $has_nav ) {
            ...
            echo '<div class="eventful-nav eventful-nav-'. esc_attr( $nav_type ) .' eventful-nav-options">';
              ...
              foreach ( $this->pre_tabs as $tab ) {
                ...
                $tab_icon  = ( ! empty( $tab['icon'] ) ) ? '<i class="eventful-tab-icon '. esc_attr( $tab['icon'] ) .'"></i>' : '';

                if ( ! empty( $tab['subs'] ) ) {

                  echo '<li class="eventful-tab-item">';

                    echo '<a href="#tab='. esc_attr( $tab_id ) .'" data-tab-id="'. esc_attr( $tab_id ) .'" class="eventful-arrow">'. wp_kses_post($tab_icon) . esc_html($tab['title']) . esc_html($tab_error) .'</a>';
                  ...
                  echo '<li class="eventful-tab-item"><a href="#tab='. esc_attr( $tab_id ) .'" data-tab-id="'. esc_attr( $tab_id ) .'">'. wp_kses_post($tab_icon) . esc_html($tab['title']) . esc_html($tab_error) .'</a></li>';
          ...
          echo '<div class="eventful-content">';
            ...
            foreach ( $this->pre_sections as $section ) {
              ...
              echo '<div class="eventful-section hidden'. esc_attr( $section_onload . $section_class ) .'" data-section-id="'. esc_attr( $section_parent . $section_slug ) .'">';
              echo ( $has_nav ) ? '<div class="eventful-section-title"><h3>'. wp_kses_post($section_icon) . esc_html($section_title) .'</h3></div>' : '';
