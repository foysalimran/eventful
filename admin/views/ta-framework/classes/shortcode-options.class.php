...
if ( ! class_exists( 'EFUL_Shortcoder' ) ) {
  class EFUL_Shortcoder extends EFUL_Abstract{
    ...
    public function __construct( $key, $params = array() ) {
      ...
      add_action( 'wp_ajax_eventful-get-shortcode-'. $this->unique, array( $this, 'get_shortcode' ) );
    ...
    public function add_footer_modal_shortcode() {
      ...
      $single_usage = ( ! $has_select ) ? ' eventful-shortcode-single' : '';
          ...
          <div class="eventful-modal-table-cell">
            ...
            <div class="eventful-modal-inner">
              <div class="eventful-modal-title">
                ...
                <div class="eventful-modal-close"></div>
              </div>
              <?php

                echo '<div class="eventful-modal-header'. esc_attr( $hide_header ) .'">';
                echo '<select>';
                ...
                foreach ( $this->pre_tabs as $tab ) {
                  ...
                  if ( ! empty( $tab['subs'] ) ) {
                    ...
                    foreach ( $tab['subs'] as $sub ) {
                      ...
                      echo '<option value="'. esc_attr( $tab_key ) .'"'. wp_kses_post($view) . wp_kses_post($shortcode) . wp_kses_post($group) .'>'. esc_html( $sub['title'] ) .'</option>';
                    ...
                    echo '</optgroup>' ;
                      ...
                      echo '<option value="'. esc_attr( $tab_key ) .'"'. wp_kses_post($view) . wp_kses_post($shortcode) . wp_kses_post($group) .'>'. esc_html( $tab['title'] ) .'</option>';
              ...
              <div class="eventful-modal-content">
                ...
                <div class="eventful-modal-load"></div>
              </div>
              <div class="eventful-modal-insert-wrapper hidden"><a href="#" class="button button-primary eventful-modal-insert"><?php echo esc_html($this->args['insert_title']); ?></a></div>
            </div>
          </div>
        </div>
      </div>
          ...
          if ( ! empty( $repeatable_fields ) ) {
            ...
            echo '<div class="eventful--repeatable">';
              ...
              echo '<div class="eventful--repeat-shortcode">';
                ...
                echo '<div class="eventful-repeat-remove fas fa-times"></div>';
