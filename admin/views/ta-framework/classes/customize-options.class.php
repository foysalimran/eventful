...
if ( ! class_exists( 'EFUL_Customize_Options' ) ) {
  class EFUL_Customize_Options extends EFUL_Abstract {
    ...
    public function add_customize_save_after( $wp_customize ) {
      do_action( "eful_{$this->unique}_save_before", $this->get_options(), $this, $wp_customize );
      do_action( "eful_{$this->unique}_saved", $this->get_options(), $this, $wp_customize );
      do_action( "eful_{$this->unique}_save_after", $this->get_options(), $this, $wp_customize );
    }
