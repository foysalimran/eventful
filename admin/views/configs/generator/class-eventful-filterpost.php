			...
			array(
				...
				'fields' => array(
					...
					array(
							...
							array(
								...
								'fields' => array(
									...
									array(
										...
										'class'      => 'eful_relate_among_taxonomies',
										'options'    => array(
											'AND' => esc_html__( 'AND', 'eventful' ),
						...
						'dependency' => array( 'eful_advanced_filter', 'not-any', 'author,sortby,status,keyword' ),
					),
					array(
						...
						'dependency' => array( 'eful_advanced_filter', 'not-any', 'taxonomy,sortby,status,keyword' ),
					),
					array(
					...
					array(
						...
						'dependency' => array( 'eful_advanced_filter', 'not-any', 'taxonomy,author,sortby,date,keyword' ),
					),
					array(
						...
						'dependency' => array( 'eful_advanced_filter', 'not-any', 'taxonomy,author,sortby,status,keyword' ),
					),
					array(
						...
						'dependency' => array( 'eful_advanced_filter', 'not-any', 'taxonomy,author,sortby,date,status' ),
					),
				),
			)
