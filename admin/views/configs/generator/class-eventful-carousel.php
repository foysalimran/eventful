			...
			array(
				...
				'fields' => array(
					...
					array(
						...
						'step'       => 100,
						'unit'       => 'ms',
						'dependency' => array( 'eful_carousel_mode', '==', 'ticker' ),
					),

					array(
						'id'         => 'eful_ticker_slide_width',
						'type'       => 'spinner',
					...
					array(
						...
						'step'       => 100,
						'unit'       => 'ms',
						'dependency' => array( 'eful_autoplay|eful_carousel_mode', '==|!=', 'true|ticker' ),
					),
					array(
						'id'         => 'eful_carousel_speed',
						'type'       => 'spinner',
						'title'      => esc_html__( 'Carousel Speed', 'eventful' ),
						'subtitle'   => esc_html__( 'Set carousel speed in millisecond.', 'eventful' ),
						'sanitize'   => 'eful_sanitize_number_field',
					...
					array(
						...
						'text_width' => 94,
						'default'    => true,
						'dependency' => array( 'eful_autoplay', '==', 'true' ),
					),
					array(
						'id'         => 'eful_infinite_loop',
						'type'       => 'switcher',
					...
					array(
						...
						'text_width' => 94,
						'default'    => true,
						'dependency' => array( 'eful_carousel_mode|eful_slide_effect', '!=|not-any', 'ticker|cube,flip' ),
					),
					array(
						'id'       => 'eful_carousel_direction',
						'type'     => 'button_set',
					...
					array(
						...
						'min'        => '1',
						'dependency' => array( 'eful_carousel_mode', '==', 'standard', true ),
					...
					array(
						...
						'default'    => 'top_right',
						'dependency' => array( 'eful_navigation|eful_carousel_mode', '!=|!=', 'hide|ticker' ),
					),
					array(
						'id'         => 'navigation_icons',
						'type'       => 'button_set',
					...
					array(
						...
						'default'    => 'dots',
						'dependency' => array( 'eful_pagination|eful_carousel_mode', '!=|!=', 'hide|ticker' ),
					),
					array(
						'id'         => 'eful_pagination_color_set',
						'type'       => 'fieldset',
						...
						'fields'     => array(
							...
							array(
								'id'         => 'eful_pagination_number_color',
								'type'       => 'color_group',
								'options'    => array(
									'color'       => esc_html__( 'Color', 'eventful' ),
									'hover-color' => esc_html__( 'Hover Color', 'eventful' ),
					...
					array(
						...
						'text_off'   => esc_html__( 'Disabled', 'eventful' ),
						'text_width' => 94,
						'dependency' => array( 'eful_carousel_mode|eful_slide_effect', '!=|not-any', 'ticker|flip,cube' ),
					),
					array(
						'id'         => 'eful_accessibility',
						'type'       => 'switcher',
