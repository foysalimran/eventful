...
class EFUL_Live_Filter
{
	 ...
	 * @return array
	 */
	public static function eful_all_taxonomy_terms_form_the_query($eventful_query, $taxonomy)
	{
	...
	public static function eventful_live_filter_reset()
	{
		...
		$query_args = EFUL_Functions::modify_query_params($query_args, $keyword, $author_id, $orderby, $order, $selected_term_list, 0, $relation, $query_post_ids, $eventful_lang);
