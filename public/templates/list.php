...
?>
<div id="eventful_wrapper-<?php echo esc_attr($eventful_gl_id); ?>" class="<?php self::eful_wrapper_classes($layout_preset, $eventful_gl_id, $pagination_type); ?>" <?php self::wrapper_data($pagination_type, $pagination_type_mobile, $eventful_gl_id); ?> data-sid="<?php echo esc_attr($eventful_gl_id); ?>" data-lang="<?php echo esc_attr($spsp_lang); ?>">
	<?php
