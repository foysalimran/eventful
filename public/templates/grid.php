...
?>
<div id="efp_wrapper-<?php echo esc_attr($eventful_gl_id); ?>" class="<?php self::efp_wrapper_classes($layout_preset, $eventful_gl_id, $grid_style, $item_same_height_class); ?>" <?php self::wrapper_data( $pagination_type, $pagination_type_mobile, $eventful_gl_id ); ?> data-lang="<?php echo esc_attr( $spsp_lang ); ?>">
