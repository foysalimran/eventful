...
?>
<!-- Markup Starts -->
<div id="eventful_wrapper-<?php echo esc_html( $eventful_gl_id ); ?>" class="<?php self::eful_wrapper_classes( $layout_preset, $eventful_gl_id, $pagination_type, $item_same_height_class ); ?> <?php self::wrapper_data( $pagination_type, $pagination_type_mobile, $eventful_gl_id ); ?> <?php echo esc_html( $carousel_mode ); ?>" data-sid="<?php echo esc_html( $eventful_gl_id ); ?>">
