...
foreach ( $social_share_media as $style_key => $style_value ) {
	switch ( $style_value ) {
		...
		case 'email':
			?>
			<a href="mailto:?Subject=<?php echo get_the_title( $post ); ?>&amp;Body=<?php echo get_the_permalink( $post ); ?>" title="<?php echo esc_attr('Email', 'eventful') ?>" class="eventful-social-icon eventful-envelope <?php echo esc_attr( $social_icon_shape ); ?>"> <i class="far fa-envelope"></i></a>
			<?php
			break;
		case 'instagram':
			?>
				<a title="<?php echo esc_attr('Instagram', 'eventful') ?>" onClick="window.open('https://instagram.com/?url=<?php echo get_the_permalink( $post ); ?>&amp;text=<?php echo get_the_title( $post ); ?>','Twitter share','width=450,height=300,left='+(screen.availWidth/2-300)+',top='+(screen.availHeight/2-150)+''); return false;" href="https://instagram.com/?url=<?php echo get_the_permalink( $post ); ?>&amp;text=<?php echo get_the_title( $post ); ?>" class="eventful-social-icon eventful-instagram <?php echo esc_attr( $social_icon_shape ); ?>"> <i class="fab fa-instagram" aria-hidden="true"></i></a>
				<?php
			break;
		case 'whatsapp':
			?>
